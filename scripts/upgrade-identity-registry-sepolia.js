...
async function main() {
  ...
  if (!identityRegistryProxy) {
    throw new Error("Missing identityRegistry address in sepolia-deployment.json");
  }
  ...
  console.log("\nUpdated sepolia-deployment.json with the new identity registry implementation address.");
}
